...
LEVEL_load_data :: proc(l: ^LEVEL_Collision, fpath: string, tag: LEVEL_Tag) {
    ...
    when !IS_WEB {
        ...
        switch tag {
        case .Open:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Shell:
            data = {0xff,0xff,0x80,0x01,0xbf,0xfd,0xa0,0x05,0xae,0x75,0xa8,0x15,0xab,0xd5,0xaa,0x55,0xaa,0x55,0xaa,0x55,0xa8,0x15,0xaf,0xf5,0xa0,0x05,0xbe,0x7d,0x80,0x01,0xff,0xff}
        case .Almost:
            data = {0xff,0xff,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x9f,0xf9,0x9f,0xf9,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0xff,0xff}
        case .Crosshair:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x80,0x01,0x82,0x41,0x9e,0x79,0x90,0x09,0x80,0x01,0x80,0x01,0x90,0x09,0x9e,0x79,0x82,0x41,0x80,0x01,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Dice3:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x80,0x19,0x80,0x19,0x80,0x01,0x80,0x01,0x81,0x81,0x81,0x81,0x80,0x01,0x80,0x01,0x98,0x01,0x98,0x01,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Dice5:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x98,0x19,0x98,0x19,0x80,0x01,0x80,0x01,0x81,0x81,0x81,0x81,0x80,0x01,0x80,0x01,0x98,0x19,0x98,0x19,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Dice6:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x99,0x99,0x99,0x99,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x99,0x99,0x99,0x99,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Eye:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x80,0x01,0x83,0xc1,0x9e,0x79,0x90,0x09,0x81,0x81,0x81,0x81,0x90,0x09,0x9e,0x79,0x83,0xc1,0x80,0x01,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Ghost:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x9e,0x79,0xff,0xff}
        case .Han:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0xff,0xff}
        case .Hideyhole:
            data = {0xff,0xff,0x80,0x01,0xfe,0x7f,0x80,0x01,0xfe,0x7f,0x80,0x01,0x80,0x01,0x81,0x81,0x81,0x81,0x80,0x01,0x80,0x01,0xfe,0x7f,0x80,0x01,0xfe,0x7f,0x80,0x01,0xff,0xff}
        case .Highway:
            data = {0xff,0xff,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0x80,0x01,0x80,0x01,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xfe,0x7f,0xff,0xff}
        case .Intersections:
            data = {0xff,0xff,0x80,0x01,0xa8,0xe1,0xa2,0x01,0xaa,0xb9,0x88,0x81,0x8a,0xaf,0x82,0x21,0xba,0xa9,0x80,0x89,0x8e,0xa9,0x80,0x21,0x83,0xad,0x80,0x01,0x80,0x21,0xff,0xff}
        case .JJ:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x87,0x01,0x81,0x01,0x81,0x01,0x91,0x01,0x91,0xf9,0x9f,0x89,0x80,0x89,0x80,0x81,0x80,0x81,0x80,0xe1,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Randommaze:
            data = {0xff,0xff,0x82,0x41,0xae,0x5d,0xa0,0x05,0xbf,0xfd,0x80,0x05,0xff,0xf5,0x81,0x05,0x81,0x65,0x9f,0x3d,0xb1,0x21,0x9b,0xbf,0xb0,0x81,0x9a,0xfd,0x82,0x01,0xff,0xff}
        case .Sidei:
            data = {0xff,0xff,0x80,0x01,0x80,0x01,0x80,0x01,0x90,0x09,0x90,0x09,0x90,0x09,0x9f,0xf9,0x9f,0xf9,0x90,0x09,0x90,0x09,0x90,0x09,0x80,0x01,0x80,0x01,0x80,0x01,0xff,0xff}
        case .Snakey:
            data = {0xff,0xff,0x9e,0x79,0x9e,0x79,0x90,0x01,0x90,0x01,0x9e,0x79,0x9e,0x79,0x82,0x09,0x82,0x09,0x9e,0x79,0x9e,0x79,0x80,0x41,0x80,0x41,0x9e,0x79,0x9e,0x79,0xff,0xff}
        case .Stacks:
            data = {0xff,0xff,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0x80,0x01,0x80,0x01,0x9e,0x79,0x9e,0x79,0xff,0xff}
        }
    }
